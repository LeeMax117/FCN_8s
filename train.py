...
# upsample_factor = 16
# modify upsample_factor from 16 to 8 to establish the FCN 8s network
upsample_factor = 8
...
upsample_filter_tensor_x2_1 = tf.Variable(upsample_filter_np_x2, name='vgg_16/fc8/t_conv_x2_2')

upsampled_logits = tf.nn.conv2d_transpose(upsampled_logits, upsample_filter_tensor_x2_1,
